...
df = pd.read_csv('C:/Users/Om Singh/PycharmProjects/historical_olympic_web_app/athlete_events.csv')
region_df = pd.read_csv('C:/Users/Om Singh/PycharmProjects/historical_olympic_web_app/noc_regions.csv')
